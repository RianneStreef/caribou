...
const legal = () => {
  return (
    <>
      ...
      <div style={{ padding: "40px" }} className="legal">
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          visiteurs du site :{" "}
          <a href="http://www.chalet-le-caribou.com" target="_blank">
            www.chalet-le-caribou.com
          </a>{" "}
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          <br />
          Le Propriétaire est : <strong>Sarah Moga</strong>
          <br />
          Adresse postale du propriétaire :{" "}
          <strong>Chalet du Caribou 73440 Val Thorens</strong>
          <br />
           <br />
          Le Créateur du site est : <strong>Rianne Streef</strong>
          <br />
          Le Responsable de la  publication est : <strong>Rianne Streef</strong>
          <br />
          Contacter le responsable de la publication :{" "}
          <strong>rianne@vts-webdesign.com</strong>
          <br />
          Le responsable de la publication est une
          <strong> personne physique</strong>
          <br />
          <br />
          Le Webmaster est  : <strong>Rianne Streef</strong>
          <br />
          Contacter le Webmaster : {" "}
          <strong>
            <a href="mailto:rianne@vts-webdesign.com?subject=Contact a partir des mentions lÃ©gales via le site www.chalet-le-caribou.com">
              rianne@vts-webdesign.com
            </a>
          </strong>
          <br />
          L’hebergeur du site est :{" "}
          <strong>Netlify 2325 3rd St #215 94107 San Francisco</strong>
          <br />
          <strong>
            <u>CREDIT :</u>{" "}
          </strong>
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          .<br />
          Le site <strong>www.chalet-le-caribou.com</strong>
          <strong> </strong>regroupe un ensemble de services, dans l'état,  mis
          à la disposition des utilisateurs. Il est ici précisé que ces derniers
          doivent rester courtois et faire preuve de bonne foi tant envers les
          autres utilisateurs qu'envers le webmaster du site
          www.chalet-le-caribou.com. Le site www.chalet-le-caribou.com est mis à
          jour régulièrement par Rianne Streef.
          <br />
          Sarah Moga s’efforce de fournir sur le site www.chalet-le-caribou.com
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          <br />
          <br />
          Le site www.chalet-le-caribou.com est par principe accessible aux
          ...
          d’impossibilité d’accès au service, www.chalet-le-caribou.com s’engage
          ...
          heures de l’intervention.  N’étant soumis qu’à une obligation de
          moyen, www.chalet-le-caribou.com ne saurait être tenu pour responsable
          de tout dommage, quelle qu’en soit la nature, résultant d’une
        ...
        <p style={{ textAlign: "justify" }}>
          <br />
          Sarah Moga est propriétaire exclusif de tous les droits de propriété
          ...
          www.chalet-le-caribou.com, représentation, modification, publication,
          ...
          autorisation écrite préalable de Sarah Moga, propriétaire du site à
          l'email : rianne@vts-webdesign.com, à défaut elle sera considérée
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          <br />
          <br />
          Le site www.chalet-le-caribou.com contient un certain nombre de liens
          hypertextes vers d’autres sites (partenaires, informations …) mis en
          place avec l’autorisation de Sarah Moga. Cependant, Sarah Moga n’a pas
          la possibilité de vérifier l'ensemble du contenu des sites ainsi
          ...
          www.chalet-le-caribou.com, un ou des cookies sont susceptibles de
        ...
        <p style={{ textAlign: "justify" }}>
          Sur le site www.chalet-le-caribou.com, Sarah Moga ne collecte des
          ...
          services proposés par le site www.chalet-le-caribou.com. L'utilisateur
          ...
          l'utilisateur du site www.chalet-le-caribou.com l’obligation ou non de
          ...
          www.chalet-le-caribou.com par email :{" "}
          <strong>
            <a href="mailto:rianne@vts-webdesign.com?subject=Contact ï¿½ partir des mentions lï¿½gales via le site www.chalet-le-caribou.com">
              rianne@vts-webdesign.com
            </a>
          </strong>{" "}
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          www.chalet-le-caribou.com n'est publiée à l'insu de l'utilisateur,
          échangée, transférée, cédée ou vendue sur un support quelconque à des
          tiers. Seule l'hypothèse du rachat du site www.chalet-le-caribou.com
          et de ses droits autorise Sarah Moga à transmettre les dites
          informations à l'éventuel acquéreur qui serait à son tour tenu à la
          même obligation de conservation et de modification des données vis à
          vis de l'utilisateur du site www.chalet-le-caribou.com.
          <br />
          Le site www.chalet-le-caribou.com est en conformité avec le RGPD voir
          notre politique RGPD  www.vts-webdesign.com/rgpd.
        </p>
