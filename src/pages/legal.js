  ...
  return (
    <div style={{ padding: "40px" }} className="legal">
      ...
      <p style={{ textAlign: "justify" }}>
        ...
        diffusées sur son site, qu’elles soient de son fait ou du fait des tiers
      ...
      <p style={{ textAlign: "justify" }}>
        ...
        d’impossibilité d’accès au service, www.chalet-le-caribou.com s’engage à
        ...
        www.chalet-le-caribou.com ne saurait être tenu pour responsable de tout
      ...
      <p style={{ textAlign: "justify" }}>
        ...
        l'email : rianne@vts-webdesign.com, à défaut elle sera considérée comme
      ...
      <p style={{ textAlign: "justify" }}>
        ...
        Pour l’exercer, adressez votre demande à www.chalet-le-caribou.com par
        email :{" "}
        <strong>
      ...
      <p style={{ textAlign: "justify" }}>
        ...
        tiers. Seule l'hypothèse du rachat du site www.chalet-le-caribou.com et
        de ses droits autorise Sarah Moga à transmettre les dites informations à
        l'éventuel acquéreur qui serait à son tour tenu à la même obligation de
        conservation et de modification des données vis à vis de l'utilisateur
        du site www.chalet-le-caribou.com.
        <br />
